...
let DEFAULT_PLACEHOLDER_STRING = 'Select...';
...
let Dropdown = function (_Component) {
    ...
    function Dropdown(props) {
        ...
        let _this = _possibleConstructorReturn(this, (Dropdown.__proto__ || Object.getPrototypeOf(Dropdown)).call(this, props));
    ...
    _createClass(Dropdown, [{
        ...
        value: function renderOption(option) {
            ...
            let optionClass = (0, _classnames2.default)((_classNames = {}, _defineProperty(_classNames, this.props.baseClassName + '-option', true), _defineProperty(_classNames, 'is-selected', option === this.state.selected), _classNames));
        ...
        value: function buildMenu() {
            ...
            let ops = options.map(function (option) {
                if (option.type === 'group') {
                    let groupTitle = _react2.default.createElement(
            'div',
            { className: baseClassName + '-title' },
            option.name
          );
                    let _options = option.items.map(function (item) {
        ...
        this.buildMenu()
            ...
            let dropdownClass = (0, _classnames2.default)((_classNames2 = {}, _defineProperty(_classNames2, className, true), _defineProperty(_classNames2, baseClassName + '-root', true), _defineProperty(_classNames2, 'is-open', this.state.isOpen), _classNames2));
